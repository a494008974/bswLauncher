package com.mylove.tvlauncher.mvp.ui.adapter;
...
//    private static final int TAG_VIEW_HOLD = 11111;
    ...
    private CommonViewHolder(Context context, ViewGroup parent, int layoutId, int position) {
        ...
        if(layoutId > 0) {
            ...
            // setTag
            this.mConvertView.setTag(R.id.public_tag_view_hold, this);
        }
    }
    ...
    public static CommonViewHolder get(Context context, View convertView,
        ...
        if(null != convertView) {
            holder = (CommonViewHolder) convertView.getTag(R.id.public_tag_view_hold);
        }
