...
public class HotelEntity {
    ...
    @Generated(hash = 1564233096)
    public HotelEntity(String id, String url, String path, String pkg,
            String action, String isAct, String createTime, String isNet) {
        this.id = id;
        this.url = url;
        this.path = path;
        this.pkg = pkg;
